...
<div class="row">
    <div class="col-lg-4">
      <h3>lectures</h3>
      <p class="text-success">Lecture 12 about Hamiltonian Monte Carlo is now downloadable..</p>
      <p><a class="btn btn-default" href="{filename}/posts/lecture12.md" role="button">More &raquo;</a></p>
    </div><!-- /.col-lg-4 -->
    <div class="col-lg-4">
      <h3>labs</h3>
    ...
    <div class="col-lg-4">
      <h3>homeworks</h3>
      <p class="text-info">HW4 is posted..</p>
      <p><a class="btn btn-default" href="{filename}/posts/homework4.md" role="button">More &raquo;</a></p>
    </div><!-- /.col-lg-4 -->
</div>
